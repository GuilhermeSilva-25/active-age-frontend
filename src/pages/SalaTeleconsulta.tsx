...
export function SalaTeleconsulta() {
  ...
  // CORREÇÃO PONTO 2: Fim dos dados chumbados! Busca o agendamento real na API.
  const carregarAgendamentoReal = async (usuarioLogado: any) => {
    try {
      ...
      if (res.ok) {
        ...
        // Procura a consulta exata que o usuário tentou abrir
      ...
      <div className="row justify-content-center">
        ...
        {user?.tipo === "MEDICO" && (
          <div className="col-lg-5 mt-4 mt-lg-0">
            ...
            >
              <div className="card-header bg-white border-bottom p-4 flex-shrink-0">
                <h5
              ...
              {/* CORREÇÃO PONTO 1: Layout com overflow e botão fixo no rodapé */}
              <div className="card-body p-4 d-flex flex-column overflow-hidden">
                <form
                ...
                >
                  ...
                  <div className="flex-grow-1 overflow-auto pe-2 pb-2">
                    <div className="alert alert-warning py-2 small fw-semibold shadow-sm">
                      <i className="bi bi-exclamation-triangle-fill me-2"></i>Ao
                      salvar, este registro torna-se imutável.
                    </div>
